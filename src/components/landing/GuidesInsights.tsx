...
export function GuidesInsights() {
  return (
    <section id="guides" className="py-40 md:py-56 relative" style={{ background: '#E9E4DE' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          {guides.map((guide) => (
            <Link
              ...
              className="group rounded-lg overflow-hidden transition-all duration-[400ms] hover:-translate-y-2 hover:shadow-lg"
              style={{
                background: '#F5F2EE',
