export function About() {
  return (
    <section id="about" className="py-32 md:py-44 relative">
      ...
      <div className="absolute inset-0" style={{ background: 'rgba(243,240,237,0.6)' }} />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="mt-16 pt-14 relative" style={{ borderTop: '1px solid rgba(134,103,88,0.15)' }}>
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-20 h-px" style={{ background: 'linear-gradient(90deg, transparent, rgba(134,103,88,0.3), transparent)' }} />
            <p 
