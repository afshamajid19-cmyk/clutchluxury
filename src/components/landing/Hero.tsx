...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_100%_60%_at_50%_40%,_rgba(233,228,222,0.6),_#E9E4DE)] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center" style={{ paddingTop: '10vh' }}>
          ...
          >
            <Button
              size="lg"
              className="w-full sm:w-auto min-w-[240px] h-16 px-14 text-[14px] tracking-[2.5px] uppercase font-semibold bg-[#866758] text-white hover:bg-[#6b5345] hover:shadow-[0_12px_40px_rgba(134,103,88,0.3)] transition-all duration-500 hover:-translate-y-1.5 border-0 rounded-sm"
            ...
            <Button
              variant="outline"
              size="lg"
              className="w-full sm:w-auto min-w-[240px] h-16 px-14 text-[14px] tracking-[2.5px] uppercase font-medium border-2 border-[#866758]/40 bg-[#866758]/[0.05] text-[#291E15] hover:bg-[#866758] hover:text-white transition-all duration-500 backdrop-blur-[10px] rounded-sm"
              onClick={() => {
